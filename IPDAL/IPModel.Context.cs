...
namespace IPDAL
{
    ...
    public partial class ItineraryPlannerEntities : DbContext
    {
        ...
        public virtual int usp_DeleteTask(Nullable<int> tripTaskId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_DeleteTask", tripTaskIdParameter);
        }
        ...
        public virtual int usp_InsertTask(Nullable<int> tripId, string taskName, string taskDescription, Nullable<System.DateTime> taskDueDate)
        {
            var tripIdParameter = tripId.HasValue ?
                new ObjectParameter("TripId", tripId) :
                new ObjectParameter("TripId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_InsertTask", tripIdParameter, taskNameParameter, taskDescriptionParameter, taskDueDateParameter);
        }
        ...
        public virtual int usp_UpdateTask(Nullable<int> tripTaskId, string taskName, string taskDescription, Nullable<System.DateTime> taskDueDate)
        {
            var tripTaskIdParameter = tripTaskId.HasValue ?
                new ObjectParameter("TripTaskId", tripTaskId) :
                new ObjectParameter("TripTaskId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_UpdateTask", tripTaskIdParameter, taskNameParameter, taskDescriptionParameter, taskDueDateParameter);
        }
